...
import org.luchini.rgalaxy.deck.behaviours.settle.DiscardForCostZeroNonAlien;
...
public class ColonyShip implements Card {
	...
	public SettleBehaviour getSettleBehaviour() {
		return new DiscardForCostZeroNonAlien();
	}
